var cordovaApp = {
    ...
    document.addEventListener('backbutton', function (e) {
      ...
      if ($('.panel.panel-in').length) {
        ...
        if (window.navigator.app && window.navigator.app.exitApp) {
          f7.dialog.confirm('Are you sure you want exit from the app?', function () {
  ...
  */
  ...
  onDeviceReady: function() {
        ...
        var clientIDs = {
        "PayPalEnvironmentProduction": "AVPoetNJw64Vvq1XXln2VIyfHnk9SJRDg2v_jGuoE0ZaJXcML1QKs5yRKoRcdIC5_S87dEaF43uDqDCl", // not needed while testing
        "PayPalEnvironmentSandbox": "ASxVfF12682mL6_VP9UI9PEqOkqyZ82hOBnExl7RsooF0TKVYXC_p011Mi0L9krYs2NEtE-TrZ8YFrxf"
        };
        ...
        function onPayPalMobileInit() {
            PayPalMobile.prepareToRender(
                ...
                new PayPalConfiguration({
                    ...
                    merchantPrivacyPolicyURL: "https://www.hotbargainsstore.com",
                    merchantUserAgreementURL: "https://www.hotbargainsstore.com/"
                }),
                function() {
  ...
  PaypalPayNow: async function(data,PayemntSuccess,PayemntError){
      var f7 = cordovaApp.f7;
      f7.preloader.show();
      var payment = new PayPalPayment(data.amount, data.currencyCode, data.reference_id, "Sale");
      
        payment.custom(data.reference_id);
        PayPalMobile.renderSinglePaymentUI(payment,PayemntSuccess,PayemntError);
